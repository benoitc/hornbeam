...
- [Custom Apps Guide](/docs/guides/custom-apps) - Python-focused patterns
- [Hooks Guide](/docs/guides/hooks) - Bidirectional callbacks
- [Distributed RPC Guide](/docs/guides/distributed-rpc) - Cluster communication
